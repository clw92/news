        ...
        <div>
         ...
         <div class={Nav.menu}>
            ...
            <svg id={Nav.logo} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114 43">
               ...
               <svg id={Nav.burger} onClick= {handleClick}   enable-background="new 0 0 510 510" viewBox="0 0 510 510" xmlns="http://www.w3.org/2000/svg">
                  <g>
            ...
            <ul id="ul" className={Nav.ul}>
               ...
               {auth ? (
				<>
					<Link href="/dashBoard"><li className={Buttons.dashboard} ><button>DASHBOARD</button></li></Link>|<li>Welcome {auth.user.email}</li>|<button onClick={logOut}>Log out</button>
				</>
			) : (
